const phoneRules = {
  ...
  it: {
    ...
    errorForStartPhone: "Il telefono dopo +39 non può iniziare con 0",
  ...
  hr: {
    ...
    errorForMinLength: "Telefon ne može imati manje od 12 znakova",
    errorForMaxLength: "Telefon ne može sadržavati više od 13 znakova",
  },
  es: {
    iso: "es",
    title: "Spain (España)",
  ...
  se: {
    ...
    errorForStartPhone: "Telefonen efter +46 kan inte börja med 0",
  ...
  dk: {
    ...
    errorForStartPhone: "Telefonnummeret efter +45 kan ikke starte med 0",
